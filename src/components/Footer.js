        ...
        <>
            ...
            <footer className="footer">
                <div className="container">
                    ...
                    <div className="footer-mobile" style={{ textAlign: 'center', padding: '20px 0' }}>
                        <Link href="/" className="logo" style={{ marginBottom: '15px', display: 'inline-block' }}>
                            UNIQUE<span>NAILS</span>
                        </Link>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '15px', marginBottom: '20px', fontSize: '0.9rem' }}>
                            <Link href="/" style={{ color: 'var(--text-muted)' }}>Home</Link>
                            <Link href="/services" style={{ color: 'var(--text-muted)' }}>Services</Link>
                            <Link href="/gallery" style={{ color: 'var(--text-muted)' }}>Gallery</Link>
                            <Link href="/about" style={{ color: 'var(--text-muted)' }}>About</Link>
                            <Link href="/contact" style={{ color: 'var(--text-muted)' }}>Contact</Link>
                        </div>

                        <div style={{ marginBottom: '15px' }}>
                            <a href={`tel:${phoneClean}`} style={{ color: 'var(--accent-gold)', fontSize: '0.9rem' }}>{phone}</a>
                        </div>
