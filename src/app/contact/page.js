                    ...
                    <AnimateOnScroll animation="fade-up">
                        <div className="section-header" style={{ marginBottom: 0 }}>
                            ...
                            <p style={{ maxWidth: '500px', margin: '0 auto' }}>
                                Ready for gorgeous nails? Reach out through WhatsApp or give me a call—I usually reply within the hour!
                            </p>
                        </div>
                    </AnimateOnScroll>
                </div>
                    ...
                    <div style={{
                        ...
                        <AnimateOnScroll animation="fade-up" delay={100}>
                            ...
                            >
                                ...
                                <p style={{ color: 'rgba(255,255,255,0.9)', marginBottom: 0 }}>Fastest way to reach me!</p>
                            </a>
                        </AnimateOnScroll>
                        ...
                        <AnimateOnScroll animation="fade-up" delay={200}>
                            ...
                            >
                                ...
                                <h3 style={{ color: 'var(--text-primary)', marginBottom: '8px', fontSize: '1.5rem' }}>Call Me</h3>
                        ...
                        <AnimateOnScroll animation="fade-up" delay={300}>
                            ...
                            >
                                ...
                                <p style={{ color: 'rgba(255,255,255,0.9)', marginBottom: 0 }}>See my latest work!</p>
                            </a>
                        </AnimateOnScroll>
                    </div>
                </div>
                    ...
                    <div style={{
                        ...
                        <AnimateOnScroll animation="fade-up" delay={100}>
                            <div style={{
                                ...
                                <h3 style={{ marginBottom: '15px' }}>Where to Find Me</h3>
                                <p style={{ color: 'var(--text-muted)', lineHeight: '1.7' }}>
                                    {addressLine1}<br />
                                    {addressLine2}
                                </p>
                                <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '15px', fontStyle: 'italic' }}>
                                    Home-based studio • Street parking available
                                </p>
                            </div>
                        </AnimateOnScroll>
                        ...
                        <AnimateOnScroll animation="fade-up" delay={200}>
                            <div style={{
                                ...
                                <h3 style={{ marginBottom: '15px' }}>Working Hours</h3>
                ...
                <div className="container">
                    <AnimateOnScroll animation="fade-up">
                        <div className="section-header">
                            <span className="section-tag">Quick Info</span>
                        ...
                        {[
                            {
                                ...
                                a: 'A few days notice is usually fine, but weekends fill up fast—try to book those a week ahead!'
                            },
                            {
                                q: 'What if I need to cancel?',
                                a: 'Life happens! Just let me know at least 24 hours before so I can offer the slot to someone else.'
                            },
                            {
                                q: 'Do you take walk-ins?',
                                a: "I work by appointment only so I can give you my full attention. Drop me a message and I'll find a time that works!"
                            }
                        ].map((faq, index) => (
            ...
            <section style={{ background: 'linear-gradient(135deg, var(--champagne) 0%, var(--nude) 100%)' }}>
                <div className="container text-center">
                    <AnimateOnScroll animation="scale">
                        <h2 style={{ marginBottom: '20px' }}>Ready for amazing nails?</h2>
                        <p style={{ maxWidth: '450px', margin: '0 auto 35px', color: 'var(--text-secondary)' }}>
                            Just one message away from nails you'll want to show off
                        </p>
                        <a
                            href={whatsappUrl}
                            target="_blank"
